...
bio-current:
  name-cn: 
  name_en: Chunming Zhang
  email: 
    - cmzhang@stat.wisc.edu # 如果有多个邮箱，请都填写上
  ...
  interests: # 分点罗列，依次以 ‘-’ 开头
    ...
    - Statistical methods with applications to imaging, neuroinformatics and bioinformatics
  ...
  homepage: 
    - https://stat.wisc.edu/staff/zhang-chunming/ # 如果有多个主页，请都填写上
  github: 
  googlescholar:  
...
![Zhang, Chunming](https://stat.wisc.edu/wp-content/uploads/sites/870/2019/03/zhang_chunming.jpg)
